...
if __name__ == '__main__':
    ...
    bigram_total_origin = word_total_origin * wlength * 2 - (1 + wlength) * wlength * nsentence
    ...
    nsamples = [i for i in range(nsample_min, nsample_max+1, nsample_step)]
    kld_word = [0]*len(nsamples)
    kld_bigram = [0]*len(nsamples)
    ...
    for nsample in range(nsample_max):
        ...
        if (nsample+1) % nsample_step == 0:
            ...
            bigram_count_accu = flatten(wc_accu, ordered_bigram)
