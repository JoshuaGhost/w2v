...
def load_embedding(fname, format="word2vec_bin", normalize=True,
    ...
    """
    assert format in ['word2vec_bin', 'word2vec', 'glove', 'dict', 'gensim', 'gensim_bin', 'combined_vectors'], "Unrecognized format"
...
def from_gensim(fname, dim=200, corpus="wiki_news", min_count = 50, normalize=False, lower=False, clean_words=False):
    return load_embedding(fname, 
                        format="gensim",
                        normalize=normalize,
