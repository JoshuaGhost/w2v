...
out_fname = Path('./simple_comb_eva_2.csv').resolve()
...
if __name__=='__main__':
    ...
    for n_subs in n_subs_list:
        ...
        for i in xrange(n_comb):
            ...
            vecs_merge = sum([vecs[:,sub_idx*dim_sub:(sub_idx+1)*dim_sub] for sub_idx in idx_list])
